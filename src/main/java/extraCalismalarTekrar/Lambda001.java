    ...
    public static void getMinValue3(List<Integer> nums){
        int min=
                nums.
                        stream().
                        distinct().
                        sorted(Comparator.reverseOrder()).//burada Comparator u kullanarak reverse...yapoyoruz,buyukten kucuge siraliyoruz
                        reduce((t,u)->u).get();
        System.out.println(min);
    }
    //4. yol
